...
<link rel="stylesheet" type="text/css" href="<?= BASE_URL; ?>App/Backend/Core/FrameworkHelper/frameworkHelper.css">
<script src="<?= BASE_URL; ?>App/Backend/Core/FrameworkHelper/frameworkHelper.js"></script>


<!-- framework mini helper icon -->
<div id="framework-mini-helper">
    <img src="<?= BASE_URL; ?>App/Backend/Core/FrameworkHelper/framework_helper_icon.png" width="45px" height="45px" />
</div>
