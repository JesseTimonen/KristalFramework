...
// Example calls
// new Cron("clean_cache_daily", "cron/tasks/clean_cache.php", "daily", "12:00:00", "2019-10-05 11:00:00");
// new Cron("clean_cache_weekly", "cron/tasks/clean_cache.php", "weekly", "12:00:00");
// new Cron("clean_cache_monthly", "cron/tasks/clean_cache.php", "monthly", "12:00:00");
// new Cron("clean_cache_yearly", "cron/tasks/clean_cache.php", "yearly", "12:00:00");
// new Cron("clean_cache_every_120_seconds", "cron/tasks/clean_cache.php", [120, "seconds"]);
// new Cron("clean_cache_every_2_days", "cron/tasks/clean_cache.php", [2, "days"], "12:00:00");